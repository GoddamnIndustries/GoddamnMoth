...
public:
    ...
    static geom_p2d rotate(const geom_p2d& n, geom_radians_t a)
    {
        return rotate(n, std::sin(a), std::cos(a));
    }
...
GEOM_CORE std::ostream& operator<<(std::ostream& stream, const geom_p2d& p);
GEOM_CORE std::istream& operator>>(std::istream& stream, geom_p2d& p);
